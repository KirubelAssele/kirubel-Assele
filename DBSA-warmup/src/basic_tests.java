...
public class basic_tests extends TestCase {
	...
	public static void test_simple(){
		...
		Reader r2 = new Reader_simple("newfile.data");
	...
	public static void test_buffered(){
		...
		Reader r2 = new Reader_buffered("newfile.data");
		assertTrue(r2.read()==16);
		assertTrue(r2.read()==128);
		assertTrue(r2.read()==-13);
		assertTrue(r2.read()==min);
	...
	public static void test_mapped(){
		int min = Integer.MIN_VALUE;
		int max = Integer.MAX_VALUE;
		Writer w = new Writer_mapped("newfile.data");
		w.write(16);
		w.write(128);
		w.write(-13);
		w.write(min);
		...
		Reader r2 = new Reader_mapped("newfile.data");
		assertTrue(r2.read()==16);
		assertTrue(r2.read()==128);
		assertTrue(r2.read()==-13);
		assertTrue(r2.read()==min);
